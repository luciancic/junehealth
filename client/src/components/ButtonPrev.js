...
function ButtonPrev({ isBlinking, handleClick }) {
  return (
    <button className={`therapist-button therapist-button-prev ${isBlinking ? 'therapist-button-blinking' : ''}`} onClick={handleClick} >
