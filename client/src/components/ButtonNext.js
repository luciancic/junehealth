...
function ButtonNext({ isBlinking, handleClick }) {
  return (
    <button className={`therapist-button therapist-button-next ${isBlinking ? 'therapist-button-blinking' : ''}`} onClick={handleClick} >
