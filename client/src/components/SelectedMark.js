...
function SelectedMark({ selected }) {
  const selectedClass = selected ? 'therapist__selected-checkmark-container--active' : '';
  return (
    <div className={`therapist__selected-checkmark-container ${selectedClass}`}>
      <svg className='therapist__selected-checkmark' width="24" height="18" viewBox="0 0 31 23" fill="none" xmlns="http://www.w3.org/2000/svg">
